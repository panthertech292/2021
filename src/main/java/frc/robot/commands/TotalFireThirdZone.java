...
public class TotalFireThirdZone extends SequentialCommandGroup {
  /** Creates a new TotalFireThirdZone. */
  private final ShooterSubsystem ShooterSubsystem;
  private final BeltSubsystem BeltSubsystem;
  public TotalFireThirdZone(ShooterSubsystem s_ShooterSubsystem, BeltSubsystem s_BeltSubsystem) {
