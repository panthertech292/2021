...
public class TotalFireSecondZone extends SequentialCommandGroup {
  ...
  public TotalFireSecondZone(ShooterSubsystem s_ShooterSubsystem, BeltSubsystem s_BeltSubsystem) {
    ...
    addCommands(
      ...
      new AimAdjustSecondZone(s_ShooterSubsystem,ShooterConstants.kShooterFull+0.065),
